...
if(isset($_POST["sub"]))
{
	...
	if($per>=60)
	{
		echo "<h4 align='center'>Grade : First Class</h4>";
	}
	else if($per>=45 && $per<=59)
	{
		echo "<h4 align='center'>Grade : Second Class</h4>";
	}
	else if($per>=33 && $per<=44)
	{
		echo "<h4 align='center'>Grade : Third Class</h4>";
	}
	else
	{
		echo "<h4 align='center'>Grade : Fail</h4>";
	}
}
?>